<aside class="group/aside top-0 left-0 fixed p-2 h-full">
  <nav class="flex flex-col justify-between bg-white shadow-xs px-6 py-8 rounded-xl w-22 group-hover/aside:w-60 h-full overflow-hidden transition-all duration-400">
    <div class="flex justify-center w-10">
      <button class="relative w-6 h-4 shrink-0">
    ...
    <ul class="flex flex-col gap-2">
      <li>
        <a href="" class="group/link relative flex items-center gap-2">
